      ...
      <b-col>
        ...
        >
          ...
          <b-card-footer
            ...
            variant="light"
          >
            <notice-reply-item v-bind="reply"></notice-reply-item>
          </b-card-footer>
        </b-card>
      </b-col>
    </b-row>
...
import { getArticle, deleteArticle, getReply, newReply } from "@/api/notice";
import NoticeReplyItem from "@/components/notice/item/NoticeReplyItem.vue";
import { mapState } from "vuex";

export default {
  components: { NoticeReplyItem },
  name: "NoticeDetail",
  data() {
    return {
      article: {},
